...
console.log(luzComedor.meta.name); // 'interuptor de la sala' Mutación
```
...
> “Hay dos clases de programadores JS, los que aprendimos con JS y los que aprendieron con otro lenguaje y tratan de usar JS como ese lenguaje” — [Sergio Xalambrí](https://twitter.com/sergiodxa)
